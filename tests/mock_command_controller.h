...
namespace test
{
    ...
    public:
        ...
        MOCK_METHOD(bool, move_active_to_workspace, (int, bool), (override));
        MOCK_METHOD(bool, move_active_to_workspace_named, (std::string const&, bool), (override));
        MOCK_METHOD(bool, move_active_to_next_workspace, (), (override));
        MOCK_METHOD(bool, move_active_to_prev_workspace, (), (override));
        MOCK_METHOD(bool, move_active_to_back_and_forth, (), (override));
        MOCK_METHOD(bool, move_to_scratchpad, (), (override));
