...
public:
    ...
    virtual bool move_to_workspace(std::vector<ContainerScope> const& scope, int number, bool back_and_forth) = 0;
    virtual bool move_to_workspace_named(std::vector<ContainerScope> const& scope, std::string const&, bool back_and_forth) = 0;
    virtual bool move_to_current_workspace(std::vector<ContainerScope> const& scope) = 0;
    virtual bool move_to_next_workspace(std::vector<ContainerScope> const& scope) = 0;
    virtual bool move_to_prev_workspace(std::vector<ContainerScope> const& scope) = 0;
    virtual bool move_to_back_and_forth(std::vector<ContainerScope> const& scope) = 0;
    virtual bool move_to_scratchpad(std::vector<ContainerScope> const& scope) = 0;
...
public:
    ...
    bool move_to_workspace(std::vector<ContainerScope> const& scope, int number, bool back_and_forth) override;
    bool move_to_workspace_named(std::vector<ContainerScope> const& scope, std::string const&, bool back_and_forth) override;
    bool move_to_current_workspace(std::vector<ContainerScope> const& scope) override;
    bool move_to_next_workspace(std::vector<ContainerScope> const& scope) override;
    bool move_to_prev_workspace(std::vector<ContainerScope> const& scope) override;
    bool move_to_back_and_forth(std::vector<ContainerScope> const& scope) override;
    bool move_to_scratchpad(std::vector<ContainerScope> const& scope) override;
