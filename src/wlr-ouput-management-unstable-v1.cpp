...
public:
    ...
    void update(miral::Output const& updated);
...
WlrOutputManagerV1::WlrOutputManagerV1(wl_resource* resource) :
    mir::wayland::OutputManagerV1(resource, Version<4>())
{
}
...
void WlrOutputHeadV1::update(miral::Output const& updated)
{
...
WlrOutputManagementUnstableV1::WlrOutputManagementUnstableV1(wl_display* display) :
    mir::wayland::OutputManagerV1::Global(display, Version<4>())
{
}

void WlrOutputManagementUnstableV1::bind(wl_resource* new__output_manager_v1)
{
    active_managers.push_back(new WlrOutputManagerV1(new__output_manager_v1));
}
