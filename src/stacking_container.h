...
#ifndef MIRACLE_WM_STACKING_CONTAINER_H
#define MIRACLE_WM_STACKING_CONTAINER_H
...
class StackingContainer : public Container
{
public:
...
#endif //MIRACLE_WM_STACKING_CONTAINER_H
