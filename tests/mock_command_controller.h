...
namespace test
{
    ...
    public:
        ...
        MOCK_METHOD(bool, try_move, (Direction, std::vector<ContainerScope> const&), (override));
        ...
        MOCK_METHOD(bool, move_to_workspace, (std::vector<ContainerScope> const&, int, bool), (override));
        MOCK_METHOD(bool, move_to_workspace_named, (std::vector<ContainerScope> const&, std::string const&, bool), (override));
        MOCK_METHOD(bool, move_to_current_workspace, (std::vector<ContainerScope> const&), (override));
        MOCK_METHOD(bool, move_to_next_workspace, (std::vector<ContainerScope> const&), (override));
        MOCK_METHOD(bool, move_to_prev_workspace, (std::vector<ContainerScope> const&), (override));
        MOCK_METHOD(bool, move_to_back_and_forth, (std::vector<ContainerScope> const&), (override));
        MOCK_METHOD(bool, move_to_scratchpad, (std::vector<ContainerScope> const&), (override));
        ...
        MOCK_METHOD(bool, try_move_active_to_output, (Direction), (override));
        MOCK_METHOD(bool, try_move_active_to_current, (), (override));
        MOCK_METHOD(bool, try_move_active_to_primary, (), (override));
        MOCK_METHOD(bool, try_move_active_to_nonprimary, (), (override));
        MOCK_METHOD(bool, try_move_active_to_next, (), (override));
        MOCK_METHOD(bool, try_move_active, (std::vector<std::string> const&), (override));
